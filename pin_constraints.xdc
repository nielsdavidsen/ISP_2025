...
#set_property PACKAGE_PIN V16 [get_ports valid]
#set_property IOSTANDARD LVCMOS33 [get_ports valid]
#set_property PACKAGE_PIN W16 [get_ports input_c]
#set_property IOSTANDARD LVCMOS33 [get_ports input_c]
#set_property PACKAGE_PIN W17 [get_ports input_d]
#set_property IOSTANDARD LVCMOS33 [get_ports input_d]
...
set_property PACKAGE_PIN T1 [get_ports {target_switch[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {target_switch[1]}]
set_property PACKAGE_PIN R2 [get_ports {target_switch[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {target_switch[0]}]


## LEDs
set_property PACKAGE_PIN U16 [get_ports in_tune]
set_property IOSTANDARD LVCMOS33 [get_ports in_tune]
set_property PACKAGE_PIN E19 [get_ports too_low]
set_property IOSTANDARD LVCMOS33 [get_ports too_low]
set_property PACKAGE_PIN U19 [get_ports too_high]
set_property IOSTANDARD LVCMOS33 [get_ports too_high]
#set_property PACKAGE_PIN V19 [get_ports {adc_out[8]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[8]}]
#set_property PACKAGE_PIN W18 [get_ports {adc_out[7]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[7]}]
#set_property PACKAGE_PIN U15 [get_ports {adc_out[6]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[6]}]
#set_property PACKAGE_PIN U14 [get_ports {adc_out[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[5]}]
#set_property PACKAGE_PIN V14 [get_ports {adc_out[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[4]}]
#set_property PACKAGE_PIN V13 [get_ports {adc_out[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[3]}]
#set_property PACKAGE_PIN V3 [get_ports {adc_out[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[2]}]
#set_property PACKAGE_PIN W3 [get_ports {adc_out[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[1]}]
#set_property PACKAGE_PIN U3 [get_ports {adc_out[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[0]}]
#set_property PACKAGE_PIN P3 [get_ports {adc_out[28]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[28]}]
#set_property PACKAGE_PIN N3 [get_ports {adc_out[29]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[29]}]
#set_property PACKAGE_PIN P1 [get_ports {adc_out[30]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[30]}]
#set_property PACKAGE_PIN L1 [get_ports {adc_out[31]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {adc_out[31]}]
...
##Sch name = XA1_N
set_property PACKAGE_PIN J3 [get_ports {adc_in[0]}]
set_property PACKAGE_PIN K3 [get_ports {adc_in[1]}]
